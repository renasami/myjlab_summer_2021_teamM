...
<ul>
            ...
            <li><a><span class='router_box'><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 -10 28 33" fill="none" stroke="#231815" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"><path d="M16 17l5-5-5-5M19.8 12H9M10 3H4v18h6"/></svg><span class='router_text'>Logout</span></span></a></li>
</ul>
